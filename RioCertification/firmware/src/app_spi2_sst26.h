/*******************************************************************************
  ...
  Description:
    ...
    "APP_SPI2_SST26_Initialize" and "APP_SPI2_SST26_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_SPI2_SST26_STATES" definition).  Both
    are defined here for convenience.
*******************************************************************************/

#ifndef _APP_SPI2_SST26_H
#define _APP_SPI2_SST26_H
...
#define APP_SPI2_SST26_CS_ENABLE()                      SPI2_CS_Clear()
#define APP_SPI2_SST26_CS_DISABLE()                     SPI2_CS_Set()

#define APP_SST26_MEM_ADDR                              0x10000
   
    
typedef enum {
    APP_SPI2_SST26_STATE_INITIALIZE,
    APP_SPI2_SST26_STATE_WAIT_MIN_POWER_UP_TIME,
    APP_SPI2_SST26_STATE_RESET,
    APP_SPI2_SST26_STATE_GLOBAL_BLK_PROTECTION_UNLOCK,
    APP_SPI2_SST26_STATE_JEDEC_ID_READ,
    APP_SPI2_SST26_STATE_SECTOR_ERASE,
    APP_SPI2_SST26_STATE_READ_STATUS,
    APP_SPI2_SST26_STATE_PAGE_PROGRAM,
    APP_SPI2_SST26_STATE_MEMORY_READ,
    APP_SPI2_SST26_STATE_VERIFY,
    APP_SPI2_SST26_STATE_XFER_SUCCESSFUL,
    APP_SPI2_SST26_STATE_XFER_ERROR,
    APP_SPI2_SST26_STATE_IDLE,
} APP_SPI2_SST26_STATES;


typedef struct {
    APP_SPI2_SST26_STATES state;
    APP_SPI2_SST26_STATES nextState;
