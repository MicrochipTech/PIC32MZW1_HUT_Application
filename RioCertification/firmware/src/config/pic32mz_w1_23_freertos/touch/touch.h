...
{                                                                                                                  \
   X(4), Y(7), 2,0, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(16), 2,0, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                   \
}
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(14), 2,0, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(11), 2,0, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                   \
}
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(8), 2,0, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                   \
}
...
#define KEY_2_PARAMS                                                                                            \
{                                                                                                              \
    35, HYST_25, AKS_GROUP_1                       \
}


#define KEY_3_PARAMS                                                                                            \
{                                                                                                              \
    30, HYST_25, AKS_GROUP_1                       \
}
